...
async function main() {
    ...
    try {
        ...
        await createCustomerFollowUpTask(customer2.id, "Check satisfaction with recent order", new Date(Date.now() + 5 * 24 * 60 * 60 * 1000));
        ...
        console.log("\n👥 All Customers:");
        console.table(customers.map((customer) => ({
            Name: customer.name,
        ...
        console.log("\n🚚 All Shipments:");
        console.table(shipments.map((shipment) => ({
