...
export class ShipmentManagerCLI {
  ...
  static quickAddTask(description: string, priority: "low" | "medium" | "high" | "urgent" = "medium") {
  ...
  static quickAddCustomer(name: string, email: string, company?: string) {
  ...
  static quickAddShipment(trackingNumber: string, customerId: string, orderNumber: string) {
  ...
  static quickUpdateShipmentStatus(trackingNumber: string, status: "pending" | "processing" | "shipped" | "in-transit" | "delivered" | "exception") {
